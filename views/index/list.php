        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                <p class="pull-right">
                    ...
                    <a href="/topic/delete/<?= $topic['id'] ?>" class="btn btn-danger" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="top" data-title="Are you sure?" data-content=" This cannot be undone!">
